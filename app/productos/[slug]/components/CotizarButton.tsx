...
function buildDefaultMessage(name: string, sku: string) {
  return `Hola King Brake! Quiero cotizar:\n• ${name} (${sku})\n\nPor favor envíenme más información.`;
}
...
export default function CotizarButton({
  ...
  const [message, setMessage] = useState(() =>
    buildDefaultMessage(productName, productSku)
  );
  ...
  return (
    <div className={styles.wrapper}>
      <button onClick={handleClick} className={styles.mainBtn} type="button">
